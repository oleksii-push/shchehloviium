...
export const questions = {
  ...
  2: [
    ...
    },
    {
      ...
      number: 8,
      question:
        "\\text{Такі ${k+2} натуральних чисел, що довільні ${k+1} з них мають спільний дільник, а всі ${k} — ні.}",
    },
    {
      vars: {
        k: mod(4),
        "k+1": (variant) => mod(4)(variant) + 1,
        "k+3": (variant) => mod(4)(variant) + 3,
      },
      number: 9,
      question:
        "\\text{Евклідовий простір та ${k+3} векторів } v_1, \\dots, v_{${k+3}}, \\text{ де вектор } v_i \\text{ ортогональний } v_{i-1} \\text{ та } v_{i+1} \\text{ і НЕортогональний усім іншим (вважаємо } v_0 = v_{${k}}, v_{${k+1}} = v_1).",
    },
  ],
  "3": [
    {
