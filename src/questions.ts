  ...
  2: [
    ...
    },
    {
      vars: {
        ...
        "2k+2": (variant) => 2*mod(2)(variant) + 2,
      },
      number: 12,
      question:
        "\\text{Натуральне число, що ділиться на ${2k+2} різних попарно НЕасоційовних гауссових, що не є натуральними.}",
    },
    {
      vars: {
        "k+3": (variant) => mod(10)(variant) + 3,
      },
      number: 13,
      question:
        "\\text{Поле з непарною кількістю елементів, у якому ${k+3} є оборотний сам до себе}",
    },
  ],
  "3": [
    {
